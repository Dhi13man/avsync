...
This project is maintained as an open-source browser tool.
...
- Try the latest `main` branch if you can.
- Include browser, OS, Node version, and file codec or rough media size.
- Do not upload private media. Describe the files or use a synthetic sample.

## Maintainer expectations

There is no guaranteed response time. Small, reproducible reports with clear
expected behavior are the easiest to act on.
